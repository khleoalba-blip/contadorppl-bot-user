...
//____________________________________________________________________________________________________________________________________________  
  //🤖 BOT CONFIGURATION
  SESSION_ID: process.env.SESSION_ID || 'Phoenix~RivalFlicker',
  STICKER_DATA: process.env.STICKER_DATA || '🎯ᴘʜᴏᴇɴɪx-ᴍᴅ;ᴀʙʜɪꜱʜᴇᴋ ꜱᴜʀᴇꜱʜ🍀',
  ALIVE_DATA: process.env.ALIVE_DATA || '👋 hola &sender, Soy *ContadorPPL ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ* Bienbenido!\n\n📌 Sumamos tus listas de loteria por ti enviala y te muestro.\n\n*ᴘʟᴀᴛꜰᴏʀᴍ:* &platform\n*ʀᴜɴᴛɪᴍᴇ:*',
  ...
  MODE: process.env.MODE || 'public', //Type public to change bot mode to publico
